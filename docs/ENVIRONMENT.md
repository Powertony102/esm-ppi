...
交互矩阵蒸馏训练（Student-LoFTR）：
- `PYTHONPATH=. python scripts/train_loftr.py --data_dir kaggle_dataset --teacher_esm_model esm2_t33_650M_UR50D --epochs 1 --batch_size 8 --precision auto --device cuda:0 --alpha_map 10.0 --temperature 4.0 --output_dir outputs`
输出：
